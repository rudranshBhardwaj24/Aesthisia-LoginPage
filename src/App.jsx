...
function App() {
  return (
    <div className="grid lg:grid-cols-2 min-h-screen overflow-hidden">
      <div className="">
        <div className="col-1 flex justify-start items-start text-white flex-col p-5 bg-[url('src/Rectangle15.png')] bg-no-repeat h-full w-full lg:ml-10 lg:mt-20  ">
          <img src="src/logo.png" alt="logo" className="mb-20" />
          ...
          <div className="mt-5 flex">
            <a href="https://aesthisia.com/" className="mr-80">
      ...
      <div className="flex flex-col justify-center items-center col-2">
        <div className="flex flex-col justify-center items-center mb-5">
          <img src="src/petals.png" className="h-[3rem]" alt="petals" />
        ...
        >
          <input
            type="email"
            className="outline-none border border-gray-400 w-[25rem] mb-[1rem] p-4 rounded-md"
          ...
          <button className="w-[25rem] p-3 bg-black text-white rounded-lg shadow-button transform translate-y-8 outline-none">
            Log in
          </button>
        </form>
        <div className="text-gray-400">
